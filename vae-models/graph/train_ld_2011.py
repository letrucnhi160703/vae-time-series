...
y_train = scaler_y.fit_transform(y_train.reshape(-1, 1)).reshape(-1, predict_steps) # just predict the first feature
...
y_test = scaler_y.transform(y_test.reshape(-1, 1)).reshape(-1, predict_steps) # just predict the first feature
